...
def _thumb_build_full_html(template: dict, formatted_context: str,
    ...
    js_scripts = ""
    if "@autofit-base" in css or "@autofit-hook" in css:
        js_scripts += r"""
<script>
(function(){document.querySelectorAll("[data-autofit]").forEach(function(c){
